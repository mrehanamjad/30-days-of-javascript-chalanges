...
const task1El = document.querySelector("#task1") as HTMLParagraphElement;
document.querySelector("#btn1")?.addEventListener("click", () => {
  task1El.textContent = "Task 1: Completed";
});

//     Task 2: Add a double-click event listener to an image that toggles its visibility.
const task2El = document.querySelector("#task2") as HTMLImageElement;
let i: number = 0;
...
const inputField2 = document.querySelector<HTMLInputElement>("#inputField2");

inputField2?.addEventListener('keyup', (e) => {
    let p = inputField2?.nextElementSibling as HTMLParagraphElement;
